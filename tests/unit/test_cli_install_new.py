...
from devsync.cli.install_new import (
    _check_for_upgrades,
...
from devsync.core.models import AIToolType, InstallationRecord, LibraryInstruction, RefType
...
class TestInstallFromLibraryTUI:
    ...
    @patch("devsync.cli.install_new.install_from_library_direct_multi_tool")
    @patch("devsync.cli.install_new.show_installer_tui")
    @patch("devsync.cli.install_new.LibraryManager")
...
class TestInstallFromLibraryDirectMultiTool:
    ...
    @patch("devsync.cli.install_new._show_installation_preview")
    @patch("devsync.cli.install_new._perform_installation")
    @patch("devsync.cli.install_new._get_ai_tools_from_names")
    @patch("devsync.cli.install_new._resolve_name_conflicts")
    @patch("devsync.cli.install_new._load_instructions_from_library")
    @patch("devsync.cli.install_new._get_project_root_for_installation")
    @patch("devsync.cli.install_new.get_detector")
    @patch("devsync.cli.install_new.LibraryManager")
...
class TestInstallationFlow:
    ...
    @patch("devsync.cli.install_new.show_installer_tui")
    @patch("devsync.cli.install_new.find_project_root")
    @patch("devsync.cli.install_new.get_detector")
    @patch("devsync.cli.install_new.LibraryManager")
    @patch("devsync.cli.install_new.InstallationTracker")
...
class TestUpgradeDetection:
    ...
    def test_check_for_upgrades_detects_version_change(self, mock_library_instruction, mock_project_with_git):
        ...
        with patch("devsync.cli.install_new.InstallationTracker") as mock_tracker_class:
