...
from devsync.core.models import LibraryInstruction, LibraryRepository
...
def mock_library_manager(monkeypatch: pytest.MonkeyPatch) -> Mock:
    ...
    monkeypatch.setattr("devsync.cli.delete.LibraryManager", lambda: mock)
    return mock
...
def mock_tracker(monkeypatch: pytest.MonkeyPatch) -> Mock:
    ...
    monkeypatch.setattr("devsync.cli.delete.InstallationTracker", lambda: mock)
    return mock
...
@patch("devsync.cli.delete.Confirm.ask")
