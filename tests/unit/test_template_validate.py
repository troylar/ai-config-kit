...
from devsync.cli.template_validate import (
    ValidationIssue,
...
class TestValidateInstallations:
    ...
    @patch("devsync.cli.template_validate.calculate_file_checksum")
    ...
    @patch("devsync.cli.template_validate.calculate_file_checksum")
    @patch("devsync.cli.template_validate.TemplateLibraryManager")
    ...
    @patch("devsync.cli.template_validate.calculate_file_checksum")
    @patch("devsync.cli.template_validate.TemplateLibraryManager")
    @patch("devsync.cli.template_validate.console")
...
class TestValidateCommand:
    ...
    @patch("devsync.cli.template_validate.find_project_root")
    @patch("devsync.cli.template_validate._validate_installations")
    @patch("devsync.cli.template_validate._display_validation_results")
