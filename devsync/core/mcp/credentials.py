...
from devsync.core.models import EnvironmentConfig, InstallationScope, MCPServer
from devsync.utils.dotenv import ensure_env_gitignored, load_env_config, save_env_config, set_env_variable
...
class CredentialManager:
    ...
    def merge_scopes(self) -> EnvironmentConfig:
        ...
        """
        from devsync.utils.dotenv import merge_env_configs
