...
from devsync.core.models import InstallationScope, MCPTemplate
...
class MCPManager:
    ...
    def __init__(self, library_root: Path):
        ...
        Args:
            library_root: Root directory for MCP library (e.g., ~/.devsync/library/)
        """
    ...
    def _parse_metadata(self, template_path: Path) -> dict:
        """
        Parse template metadata from devsync.yaml.
