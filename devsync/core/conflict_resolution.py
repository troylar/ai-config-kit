...
from devsync.core.checksum import sha256_file, sha256_string
from devsync.core.models import ConflictInfo, ConflictResolution, ConflictType, TemplateInstallationRecord
from devsync.utils.paths import resolve_conflict_name
...
def apply_resolution(template_path: Path, new_content: str, resolution: ConflictResolution) -> Path:
    ...
    Backups stored in .devsync/backups/<timestamp>/
    ...
    if resolution == ConflictResolution.SKIP:
        ...
        if template_path.exists():
            from devsync.utils.backup import create_backup
