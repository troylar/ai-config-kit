...
from devsync.cli.package_create import create_package_command
from devsync.cli.package_install import InstallationResult, install_package
...
def list_packages_command(
    ...
    try:
        ...
        # Get tracker
        data_dir = _resolve_data_dir(project_root, ".devsync", [".ai-config-kit", ".instructionkit"])
        tracker_file = data_dir / "packages.json"
