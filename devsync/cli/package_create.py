...
from devsync.core.component_detector import ComponentDetector, DetectionResult
from devsync.core.package_creator import PackageCreationResult, PackageCreator, PackageMetadata, get_git_author
...
def create_package_command(
    ...
    try:
        ...
        if detection_result.total_count == 0:
            ...
            console.print("[dim]  - Resources: .devsync/resources/[/dim]")
            raise typer.Exit(1)
