...
from devsync.ai_tools.mcp_syncer import MCPSyncer
...
def mcp_sync_command(
    ...
    environment variables from .devsync/.env, and writes them to AI
    ...
    try:
        ...
        # Create syncer
        syncer = MCPSyncer(
            library_root=_resolve_data_dir(Path.home(), ".devsync", [".instructionkit"]) / "library",
