...
from devsync.core.conflict_resolution import ConflictResolver, prompt_conflict_resolution
...
from devsync.utils.ui import print_error, print_info, print_success
...
def install_from_repo_direct(
    ...
    from devsync.cli.install import install_instruction as original_install
