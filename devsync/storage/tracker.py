...
from devsync.utils.paths import get_installation_tracker_path
from devsync.utils.project import get_project_installation_tracker_path
...
class InstallationTracker:
    ...
    Stores installation records in ~/.devsync/installations.json
    """
