...
from devsync.core.template_manifest import load_manifest
from devsync.utils.git_helpers import clone_template_repo, get_repo_version
from devsync.utils.namespace import derive_namespace
from devsync.utils.paths import _resolve_data_dir


class TemplateLibraryManager:
    """Manages template repositories in local library (~/.devsync/templates/)."""
    ...
    def __init__(self, library_path: Optional[Path] = None):
        ...
        Args:
            library_path: Custom library path (default: ~/.devsync/templates/)
        """
        if library_path is None:
            data_dir = _resolve_data_dir(Path.home(), ".devsync", [".instructionkit"])
            library_path = data_dir / "templates"
